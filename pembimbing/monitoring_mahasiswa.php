...
<body class="flex h-screen overflow-hidden text-gray-800">
            ...
            <div class="max-w-[1200px] mx-auto space-y-5">
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    <div class="flex items-start justify-between mb-5">
                        <div><h2 class="text-xl font-bold text-gray-900">Monitoring Mahasiswa</h2><p class="text-gray-500 text-sm mt-0.5">Pantau presensi mahasiswa magang</p></div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                        <p class="text-[14px] font-semibold text-gray-700">Data Presensi</p>
    ...
    <script>
        function filterRows() {
            ...
            document.querySelectorAll('.data-row').forEach(r => { r.style.display = r.dataset.search.includes(q) ? '' : 'none'; });
        }
    </script>
</body>
</html>
