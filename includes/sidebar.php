...
$menus = [
    ...
    'admin' => [
        ['title' => 'Dashboard', 'icon' => 'fa-chart-line', 'url' => '#', 'id' => 'dashboard_admin'],
        ['title' => 'Kelola Pengguna', 'icon' => 'fa-users', 'url' => '#', 'id' => 'users'],
        ['title' => 'Kelola Instansi', 'icon' => 'fa-building', 'url' => '#', 'id' => 'instansi'],
        ['title' => 'Rekap Absensi', 'icon' => 'fa-calendar-alt', 'url' => '#', 'id' => 'rekap_absen'],
        ['title' => 'Pengaturan', 'icon' => 'fa-cog', 'url' => '#', 'id' => 'settings'],
    ],
    'dosen' => [
