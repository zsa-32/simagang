...
$menus = [
    'mahasiswa' => [
        ...
        ['title' => 'Project',         'icon' => 'fa-tasks',         'url' => 'project.php',          'id' => 'project'],
        ['title' => 'Laporan Akhir',   'icon' => 'fa-file-alt',      'url' => 'laporan.php',          'id' => 'laporan'],
        ['title' => 'Lihat Nilai',     'icon' => 'fa-star',          'url' => 'nilai.php',            'id' => 'nilai'],
        ['title' => 'Kontak Darurat',  'icon' => 'fa-phone-alt',     'url' => 'kontak_darurat.php',   'id' => 'kontak_darurat'],
    ],
    'admin' => [
        ...
        ['title' => 'Perusahaan Mitra',       'icon' => 'fa-building',           'url' => 'manajemen_perusahaan.php',  'id' => 'manajemen_perusahaan',   'group' => 'MASTER DATA'],
        ['title' => 'Kelompok Magang',        'icon' => 'fa-layer-group',        'url' => 'manajemen_group.php',       'id' => 'manajemen_group',        'group' => 'MASTER DATA'],
        ['title' => 'Pembimbing Lapang',      'icon' => 'fa-user-tie',           'url' => 'manajemen_pembimbing.php',  'id' => 'manajemen_pembimbing',   'group' => 'MASTER DATA'],
